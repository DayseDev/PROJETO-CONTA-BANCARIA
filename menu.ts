...
export function main() {
    ...
    while (true) {
        ...
        switch (opcao) {
            ...
            case 3:
                console.log(colors.fg.whitestrong,
                    "\n\nConsultas dados da Conta - por numero\n\n", colors.reset);
            ...
            case 8:
                ...
                console.log("\nDigite o valor do Transferencia (R$): ");
...
function sobre(): void {
    console.log("\n*****************************************************");
    console.log("Projeto Desenvolvido por: Dayse Santos                 ");
    console.log("dayse.ccb18@gmail.com                                  ");
    console.log("github.com/DayseDev                                    ");
    console.log("*******************************************************");
}
